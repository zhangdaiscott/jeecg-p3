	...
	function validationMessage(obj, Validatemsg) {
	    try {
	        removeMessage(obj);
	        //update-begin-author:taoyan for:webuploader上传校验必填bug(校验若有隐藏的元素offset全是0，所以在此找他的上级元素)---
	        ...
	        //update-end-author:taoyan for:webuploader上传校验必填bug(校验若有隐藏的元素offset全是0，所以在此找他的上级元素)---
