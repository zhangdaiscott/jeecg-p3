...
$(function(){
	...
	$("#custom_add").click(function(){
		var tr = $("#add_order_custom_template tr").clone();
		$("#custom_table tbody").append(tr);
		resetTrNum('custom_table');
	});
	
	$("#product_add").click(function(){
		var tr = $("#add_order_product_template tr").clone();
		$("#product_table tbody").append(tr);
		resetTrNum('product_table');
	});
	
	$("#product_del").click(function(){
		$("#product_table").find("input:checked").parent().parent().remove();   
        resetTrNum('product_table'); 
        return false;
	});
	
	$("#custom_del").click(function(){
		$("#custom_table").find("input:checked").parent().parent().remove();   
        resetTrNum('custom_table'); 
        return false;
	});
});
